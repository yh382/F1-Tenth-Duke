...
static const _Waypoint_type_support_symbol_names_t _Waypoint_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces_hot_wheels, msg, Waypoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces_hot_wheels, msg, Waypoint)),
  }
};
...
{
  return &::interfaces_hot_wheels::msg::rosidl_typesupport_cpp::Waypoint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, interfaces_hot_wheels, msg, Waypoint)() {
  return get_message_type_support_handle<interfaces_hot_wheels::msg::Waypoint>();
}
