...
#include "interfaces_hot_wheels/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _Waypoint_type_support_symbol_names_t _Waypoint_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces_hot_wheels, msg, Waypoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interfaces_hot_wheels, msg, Waypoint)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_interfaces_hot_wheels
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, interfaces_hot_wheels, msg, Waypoint)() {
  return &::interfaces_hot_wheels::msg::rosidl_typesupport_c::Waypoint_message_type_support_handle;
}
