...
path = '/home/william/sim_ws/src/f1tenth_slam_pure_pursuit-main/pure_pursuit/waypoints/'
# with open(path+'just_to_interpolate.csv', 'r') as csvfile:
with open(path+'Hudson5.csv', 'r') as csvfile:
...
with open(path+'interped.csv', 'w') as csvfile:
