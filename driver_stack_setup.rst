...
#. Setting up : `udev rules <udev_rules>`.
#. Installing : `ROS 2 and its utilities <install_ros2>`.
#. Setting up the `driver stack <software_stack>`.
#. Launch : `teleoperation and the LiDAR <teleop_setup>`.
