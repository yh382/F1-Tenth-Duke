        ...
        while True:
            ...
            if xyxy_list:
                for i in range(len(xyxy_list)):
                    ...
                    w_pixel = xyxy_list[i][2] - xyxy_list[i][0]  # 计算边界框的像素宽度
                    ...
                    # label = " {} W: {:.2f}m".format(str(camera_xyz), w_real) show xyz and width
                    
                    label = "Distance: {:.2f} Width: {:.2f}".format(camera_xyz[2], w_real)
                    
                    # label = "Distance: {:.2f} Width: {:.2f}m".format(camera_xyz[2], w_real)
